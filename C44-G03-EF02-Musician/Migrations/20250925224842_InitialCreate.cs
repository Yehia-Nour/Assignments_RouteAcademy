    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicianInstruments", x => new { x.InstrumentsId, x.MusiciansId });
                    table.ForeignKey(
                        name: "FK_MusicianInstruments_Instruments_InstrumentsId",
                        column: x => x.InstrumentsId,
                        principalTable: "Instruments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicianInstruments_Musicians_MusiciansId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicianSongs", x => new { x.MusiciansId, x.SongsId });
                    table.ForeignKey(
                        name: "FK_MusicianSongs_Musicians_MusiciansId",
                        column: x => x.MusiciansId,
                        principalTable: "Musicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicianSongs_Songs_SongsId",
                        column: x => x.SongsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusicianInstruments_MusiciansId",
                table: "MusicianInstruments",
                column: "MusiciansId");

            migrationBuilder.CreateIndex(
                name: "IX_MusicianSongs_SongsId",
                table: "MusicianSongs",
                column: "SongsId");
